      ...
      <div className="section-container">
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <Link href="/" className="shrink-0 group">
            <span className="font-display text-lg font-bold text-warm-gold leading-tight block group-hover:text-yellow-300 transition-colors">Kelly Brach</span>
          ...
          {/* Desktop phone CTA */}
          <a href={phoneHref}
            className="hidden md:flex items-center gap-2 bg-warm-gold hover:bg-yellow-600 transition-colors text-white font-mono text-sm font-bold px-4 py-2 rounded-sm shrink-0">
        ...
        <div className="lg:hidden bg-navy border-t border-white/10">
          <div className="section-container py-5 flex flex-col gap-4">
            ...
            <div className="pb-4 border-b border-white/10">
              ...
              <a href={phoneHref} className="font-mono text-2xl font-bold text-warm-gold hover:text-yellow-300 transition-colors">
                {phone}
              </a>
